...
from front_analysise.modules.parser import PHPParser, HTMLParser, JSParser, DlinkHNAPXMLParser
...
F_FILTERS = [Para_repeattime_in_front]
...
# 删除特定文件名
REMOVE_FILE = ["device.xml", "defaultvalue.xml", "jquery.js", "bootstrap.min.js", "bootstrap.js", "zlib_decompressed"]
# SPECIAL_PATH = ["help"]
SPECIAL_PATH = []
